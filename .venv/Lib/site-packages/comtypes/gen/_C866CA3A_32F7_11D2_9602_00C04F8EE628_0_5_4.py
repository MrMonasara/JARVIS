...
__all__ = [
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRGCmdLoadFromMemory',
    'SPINTERFERENCE_LATENCY_WARNING', 'eLEXTYPE_PRIVATE1',
    'SPWT_DISPLAY', 'SPPROPERTYINFO', 'DISPID_SDKCreateKey',
    'SPRECOGNIZERSTATUS', 'SPADAPTATIONRELEVANCE',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPRsCount', 'ISpAudio',
    'DISPID_SBSFormat', 'SPAO_RETAIN_AUDIO', 'SAFT24kHz8BitStereo',
    'SPRST_NUM_STATES', 'SpeechStreamSeekPositionType',
    'SPPS_RESERVED3', 'DISPID_SDKGetBinaryValue',
    'SAFTCCITT_uLaw_11kHzMono', 'SPSVerb', 'SRCS_Enabled',
    'SpeechRecoProfileProperties', 'SpMMAudioEnum',
    'SAFTTrueSpeech_8kHz1BitMono', 'SREPrivate', 'ISpShortcut',
    'DISPID_SOTId', 'SREStreamEnd', 'SRAORetainAudio', 'SP_VISEME_20',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SGRSTText',
    'DISPID_SGRSAddWordTransition', 'SPLO_DYNAMIC',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SMSADeviceId',
    'DISPID_SRCERequestUI', 'DISPID_SOTCDefault',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SGRSTWeight', 'SITooFast',
    'DISPID_SPEAudioTimeOffset', 'STCInprocHandler',
    'SpeechVoiceSkipTypeSentence', 'SBONone', 'SpeechInterference',
    'SAFT44kHz16BitStereo', 'SpeechRecognitionType', 'DISPID_SVSkip',
    'SVP_2', 'SDA_One_Trailing_Space', 'SPSEMANTICFORMAT',
    'SPEI_PHONEME', 'DISPID_SLPs_NewEnum', 'DISPID_SASState',
    '_SPAUDIOSTATE', 'DISPID_SPARecoResult', 'DISPID_SPPsCount',
    'SVSFDefault', 'DISPID_SLPSymbolic', 'STSF_LocalAppData',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAUDIOSTATUS',
    'DISPID_SPAPhraseInfo', 'SPEI_RESERVED3',
    'SGLexicalNoSpecialChars', 'SPINTERFERENCE_NONE',
    'SAFT16kHz16BitStereo', 'ISpRecoContext2', 'eLEXTYPE_PRIVATE8',
    'eLEXTYPE_APP', 'SAFTCCITT_uLaw_11kHzStereo', 'SPAUDIOBUFFERINFO',
    'SSFMCreate', 'ISpeechLexicon', 'SPEI_MIN_TTS',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE20', 'SVSFIsFilename',
    'SECFIgnoreKanaType', 'DISPID_SRGDictationUnload',
    'ISequentialStream', '_ISpeechVoiceEvents', 'SP_VISEME_6',
    'DISPID_SDKGetlongValue', 'DISPID_SRCResume',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_USER', 'ISpeechResourceLoader',
    'DISPID_SABIBufferSize', 'ISpeechTextSelectionInformation',
    'SRERequestUI', 'DISPID_SPPs_NewEnum', 'ISpeechFileStream',
    'DISPID_SVSInputWordLength', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPRs_NewEnum', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechGrammarRule', 'SPSFunction', 'SPEI_UNDEFINED',
    'SVSFPurgeBeforeSpeak',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPPEngineConfidence', 'SPEI_PHRASE_START',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechObjectTokenCategory',
    'SDTAlternates', 'DISPID_SAStatus', 'SPPS_LMA',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SGRSTPropertyName', 'SWPKnownWordPronounceable',
    'SPAUDIOOPTIONS', 'SDKLLocalMachine', 'SPPHRASE',
    'SPINTERFERENCE', 'SPCONTEXTSTATE', 'DISPID_SRGState',
    'ISpRecoResult', 'SRSActiveAlways', 'SpeechCategoryRecoProfiles',
    'SP_VISEME_8', 'SPVPRI_ALERT', 'DISPID_SRRTimes', 'SLTUser',
    'DISPID_SpeechLexiconProns', 'DISPID_SPCLangId',
    'DISPID_SPRsItem', 'SpeechVoiceCategoryTTSRate',
    'eLEXTYPE_RESERVED6', 'SPEI_TTS_BOOKMARK',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechTokenContext',
    'SAFT12kHz16BitMono', 'DISPID_SPRDisplayAttributes', 'SLODynamic',
    'SAFT16kHz8BitStereo', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SOTGetAttribute', 'DISPID_SOTGetDescription',
    'SREFalseRecognition', 'SVP_1', 'DISPID_SGRName',
    'DISPIDSPTSI_ActiveOffset', 'SDKLCurrentUser', 'SPLEXICONTYPE',
    'STCRemoteServer', 'DISPID_SpeechPhraseAlternates',
    'SPBINARYGRAMMAR', 'Speech_StreamPos_RealTime', 'SP_VISEME_1',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SLWWord',
    'DISPID_SRGSetTextSelection', 'SPAS_CLOSED', 'SFTSREngine',
    ...
    'SpeechWordType', 'DISPID_SRGSetWordSequenceData',
    ...
    'SPAUDIOSTATE', 'DISPID_SPRuleNumberOfElements', 'SREStreamStart',
    'DISPID_SPPFirstElement', 'DISPID_SVVoice', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRsFindRule', 'SPEI_MAX_SR', 'ISpPhraseAlt',
    'SPEI_REQUEST_UI', 'DISPID_SpeechPhraseProperty',
    'SAFTADPCM_44kHzStereo', 'DISPID_SWFEAvgBytesPerSec',
    'SP_VISEME_12', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVGetAudioOutputs', 'SPPHRASERULE', 'SPVPRI_NORMAL',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechPhraseElements',
    'SAFT48kHz8BitStereo', '_RemotableHandle', 'SPEI_START_SR_STREAM',
    'DISPID_SRRSpeakAudio', 'SVSFNLPSpeakPunc',
    'DISPID_SRRSetTextFeedback', 'SPAO_NONE', 'SVP_12',
    'DISPID_SOTDataKey', 'SDTProperty', 'SVEAllEvents',
    'ISpeechAudioFormat', 'DISPID_SRGetRecognizers',
    'SECFNoSpecialChars', 'SREPropertyNumChange',
    'DISPID_SREmulateRecognition', 'SPWORDTYPE',
    'DISPID_SRCSetAdaptationData', 'SWTAdded',
    'DISPID_SASNonBlockingIO', 'SRSInactiveWithPurge',
    'DISPID_SPEs_NewEnum', 'SPEI_SOUND_START',
    'ISpeechPhraseReplacements', 'DISPID_SAFGuid',
    'SpeechRetainedAudioOptions', 'SpeechPropertyResourceUsage',
    'SVP_11', 'SVEViseme', 'SP_VISEME_11', 'SDKLDefaultLocation',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLPsItem',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT8kHz16BitMono',
    'SPWORD', 'SPEI_FALSE_RECOGNITION', 'DISPID_SRRRecoContext',
    'DISPID_SRIsShared', 'SpeechPropertyResponseSpeed',
    'DISPID_SRCPause', 'SpeechVoiceSpeakFlags',
    'SAFTGSM610_44kHzMono', 'SAFT48kHz16BitMono',
    'DISPID_SOTCategory', 'SPSHT_NotOverriden', 'SPEI_TTS_PRIVATE',
    'eLEXTYPE_PRIVATE19', 'SRESoundStart', 'eLEXTYPE_PRIVATE4',
    'SAFTNoAssignedFormat', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechPhraseElements', 'DISPID_SRCEPropertyStringChange',
    'ISpeechWaveFormatEx', 'SPSHT_Unknown', 'SpeechAddRemoveWord',
    'SPEI_MIN_SR', 'DISPID_SBSSeek', 'DISPID_SRCEAudioLevel',
    'SPRECORESULTTIMES', 'DISPID_SVSInputWordPosition',
    'SpeechRuleAttributes', 'SPEI_END_INPUT_STREAM',
    'SPINTERFERENCE_TOOQUIET', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFT24kHz16BitStereo', 'SPVPRI_OVER', 'DISPID_SDKDeleteValue',
    'ISpeechObjectToken', 'ISpeechGrammarRuleStateTransitions',
    'SSSPTRelativeToEnd', 'ISpeechLexiconWord', 'DISPID_SMSGetData',
    'DISPID_SPPChildren', 'SpeechRecoContextState',
    'DISPID_SpeechLexiconPronunciation', 'SVP_0', 'SITooLoud',
    'SAFTCCITT_ALaw_8kHzMono', 'STSF_AppData', 'SPCT_SLEEP',
    'SPWAVEFORMATTYPE', 'SpCompressedLexicon', 'SAFT22kHz16BitStereo',
    'SAFT22kHz8BitMono', 'ISpRecognizer3', 'SpNullPhoneConverter',
    'DISPID_SRSCurrentStreamPosition',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechBaseStream',
    'SPSSuppressWord', 'SAFT12kHz8BitStereo', 'DISPID_SRSClsidEngine',
    'SDTRule', 'SVEAudioLevel', 'SpeechFormatType',
    'DISPID_SPRNumberOfElements', 'SPSNoun', 'SpeechMicTraining',
    'SVP_10', 'DISPID_SRRTLength', 'SAFT48kHz16BitStereo',
    'SVEVoiceChange', 'SAFTText', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE18', 'DISPID_SPISaveToMemory', 'SPPS_RESERVED4',
    'SAFT32kHz16BitStereo', 'DISPID_SGRSTRule',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpObjectTokenCategory',
    'SRSActive', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpLexicon', 'SDTAudio', 'DISPID_SRSetPropertyString',
    'DISPID_SVAudioOutput', 'ISpeechLexiconPronunciations',
    'DISPID_SWFEBitsPerSample', 'SPSERIALIZEDRESULT',
    'STCInprocServer', 'DISPID_SRCESoundStart', 'SAFT32kHz8BitMono',
    'DISPID_SPRFirstElement', 'DISPID_SVEWord', 'DISPID_SVEViseme',
    'DISPID_SGRsCommitAndSave', 'ISpNotifyTranslator',
    'DISPID_SpeechObjectTokens', 'SPEI_VOICE_CHANGE', 'SVSFIsXML',
    'SpeechCategoryAudioIn', 'SSSPTRelativeToCurrentPosition',
    'ISpEventSink', 'SVSFPersistXML', 'SVEBookmark',
    'DISPID_SVGetVoices', 'DISPID_SVIsUISupported',
    'SpeechPropertyHighConfidenceThreshold', 'SpNotifyTranslator',
    'DISPID_SVSpeakStream', 'SPEI_SR_PRIVATE',
    'Speech_Max_Word_Length', 'SPSHT_EMAIL', 'SRESoundEnd',
    'SSTTTextBuffer', 'DISPID_SVRate', 'DISPID_SVEStreamEnd',
    'SFTInput', 'DISPID_SLWPronunciations', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRGRecoContext', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPIStartTime', 'SRSInactive',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPEDisplayAttributes',
    'SGRSTTWildcard', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_RESERVED7', 'DISPID_SABIMinNotification',
    'DISPID_SRCERecognitionForOtherContext', 'SpInProcRecoContext',
    ...
    'SAFT8kHz16BitStereo', 'DISPID_SGRSTs_NewEnum', 'SREAdaptation',
    'SPVPRIORITY', 'SpeechVisemeFeature', 'SpeechLoadOption',
    'ISpeechGrammarRuleStateTransition', 'SpeechPartOfSpeech',
    'SVP_19', 'DISPID_SLWType', 'ISpeechPhraseInfo',
    'ISpeechRecoGrammar', 'DISPID_SGRsDynamic', 'DISPID_SPCIdToPhone',
    'eLEXTYPE_PRIVATE10', 'DISPID_SVSPhonemeId', 'DISPID_SPEsCount',
    'ISpNotifySource', 'DISPID_SRCEHypothesis',
    'DISPID_SPIProperties', 'SAFT12kHz8BitMono',
    'DISPID_SRGDictationLoad', 'ISpeechRecoResult', 'DISPID_SLPType',
    'SGPronounciation', 'SRAONone', 'SPPS_NotOverriden',
    'DISPID_SRCState', 'DISPID_SPIAudioSizeBytes',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechWordPronounceable',
    'DISPID_SRSAudioStatus', 'SREHypothesis', 'SAFT22kHz8BitStereo',
    'DISPID_SGRClear', 'SGRSTTRule', 'DISPID_SRCEBookmark',
    'tagSPPROPERTYINFO', 'SRAImport', 'SPSHT_OTHER',
    'SAFT24kHz8BitMono', 'eLEXTYPE_PRIVATE13', 'DISPID_SRGetFormat',
    'SPDKL_CurrentConfig', 'DISPID_SpeechDataKey',
    'SpeechGrammarWordType', 'DISPID_SWFESamplesPerSec',
    'SAFT32kHz8BitStereo', 'DISPID_SRCESoundEnd',
    'DISPID_SVSLastBookmark', 'SITooSlow', 'ISpeechAudioBufferInfo',
    'SRTEmulated', 'SpAudioFormat', 'DISPID_SOTRemove',
    'DISPID_SGRsAdd', 'ISpeechPhoneConverter',
    'DISPID_SASFreeBufferSpace', 'DISPID_SpeechMMSysAudio',
    'SAFT44kHz16BitMono', 'Speech_StreamPos_Asap',
    'DISPID_SVEVoiceChange', 'SP_VISEME_9', 'SP_VISEME_4',
    'SPEI_MAX_TTS', 'SP_VISEME_21', 'DISPID_SRRSaveToMemory',
    ...
    'SGRSTTDictation', 'SPRECOSTATE', 'SVP_18', 'SpeechAudioState',
    'DISPID_SWFEExtraData', 'DISPID_SLGenerationId', 'SPBO_NONE',
    'SPCT_DICTATION', 'SpTextSelectionInformation',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCEPhraseStart', 'SPEI_SOUND_END',
    'eWORDTYPE_DELETED', 'SPRULESTATE', 'SRAInterpreter',
    'ISpeechRecoResult2', 'SPWORDPRONUNCIATIONLIST', 'SPSMF_UPS',
    'DISPID_SGRsCommit', 'SVF_Stressed', 'SAFT12kHz16BitStereo',
    'DISPID_SPPName', 'eLEXTYPE_PRIVATE15', 'SPDKL_CurrentUser',
    'ISpPhoneConverter', 'SVP_15', 'SPSTREAMFORMATTYPE',
    'SPRST_ACTIVE', 'ISpeechObjectTokens', 'SPEI_INTERFERENCE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPXRO_SML', 'DISPID_SPPParent',
    'SPVOICESTATUS', 'SAFT8kHz8BitMono', 'DISPID_SVEventInterests',
    'SpMMAudioIn', 'ISpSerializeState', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechAudioProperties', 'SpeechEngineConfidence',
    'ISpXMLRecoResult', 'SVP_3', 'ISpeechMemoryStream',
    'DISPID_SpeechRecoContext', 'SAFTExtendedAudioFormat',
    'SpeechRecognizerState', 'SAFTADPCM_8kHzStereo',
    'SPDKL_DefaultLocation', 'DISPID_SRCBookmark',
    'DISPID_SPELexicalForm', 'SSTTWildcard',
    'DISPID_SRRGetXMLErrorInfo', 'SDTReplacement',
    'SPSEMANTICERRORINFO', 'DISPID_SOTCSetId',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCCreateResultFromMemory',
    'SPGRAMMARWORDTYPE', 'SVESentenceBoundary', 'SPPS_RESERVED1',
    'DISPID_SPEsItem', 'DISPID_SPIGetText', 'DISPID_SOTCGetDataKey',
    'SGDSActive', 'eLEXTYPE_PRIVATE16', 'SDTAll', 'SDTDisplayText',
    'SP_VISEME_10', 'SPRS_ACTIVE_USER_DELIMITED', 'SWTDeleted',
    'SpeechTokenValueCLSID', 'SPSLMA', 'DISPID_SVGetAudioInputs',
    'eLEXTYPE_MORPHOLOGY', 'SGLexical', 'DISPID_SPPId', 'SRATopLevel',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_PRIVATE7',
    'SpeechTokenKeyFiles', 'SPVISEMES', 'SPDKL_LocalMachine',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SAEventHandle',
    'ISpeechPhraseProperty', 'SECHighConfidence',
    'DISPID_SDKGetStringValue', 'SPGS_EXCLUSIVE',
    '_ISpeechRecoContextEvents', 'SPSMF_SAPI_PROPERTIES',
    'SPLO_STATIC', 'SRCS_Disabled', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPPS_SuppressWord', 'ISpRecoContext',
    'DISPID_SPIEnginePrivateData', 'SPEI_PROPERTY_NUM_CHANGE',
    'SVPNormal', 'UINT_PTR', 'SVP_21', 'SSFMCreateForWrite',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_PRIVATE9',
    'DISPID_SGRAddState', 'SP_VISEME_2', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRCCreateGrammar',
    'ISpObjectTokenCategory', 'DISPID_SpeechRecoResult', 'SGRSTTWord',
    'SVP_17', 'SPINTERFERENCE_TOOFAST', 'DISPID_SGRAttributes',
    'SPFM_OPEN_READONLY', 'SDTLexicalForm', 'SVP_6',
    'SPINTERFERENCE_NOSIGNAL', 'ISpMMSysAudio',
    'DISPID_SpeechGrammarRuleState', 'SpeechPropertyAdaptationOn',
    'DISPID_SPPConfidence', 'ISpeechRecoContext', 'SPPARTOFSPEECH',
    'SpeechStreamFileMode', 'SECFIgnoreCase', 'ISpeechPhraseRule',
    'ISpeechGrammarRules', 'SpFileStream', 'ISpStream', 'LONG_PTR',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_PRIVATE11', 'SINoise',
    'SINone', 'DISPID_SLPPartOfSpeech', 'SpeechCategoryVoices',
    'SpVoice', 'DISPID_SMSSetData', 'SpeechTokenShellFolder',
    'DISPID_SOTSetId', 'ISpeechLexiconWords', 'SpeechVoicePriority',
    'SAFT44kHz8BitMono', 'SpeechDisplayAttributes',
    'DISPID_SLWs_NewEnum', 'DISPID_SGRSTType', 'tagSTATSTG',
    ...
    'SpeechLexiconType', 'DISPID_SRCVoice', 'ISpLexicon',
    ...
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRCEEndStream',
    'SPXMLRESULTOPTIONS', 'SAFT11kHz8BitStereo', 'SRADefaultToActive',
    'SRTSMLTimeout', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SREAllEvents',
    'DISPID_SPCPhoneToId', 'DISPID_SPAsCount', 'STSF_FlagCreate',
    'SVSFVoiceMask', 'SpSharedRecognizer',
    'DISPID_SRGDictationSetState', 'DISPID_SRSCurrentStreamNumber',
    'SPBO_AHEAD', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVDisplayUI', 'DISPID_SOTRemoveStorageFileName',
    'SPSInterjection', 'SGRSTTEpsilon', 'DISPID_SVEBookmark',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RESERVED6', 'SAFTADPCM_8kHzMono',
    'SVPAlert', 'ISpNotifySink', 'SPSModifier', 'SPEI_HYPOTHESIS',
    'SVEPrivate', 'DISPID_SVPause', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPRuleParent', 'SPEI_RESERVED1',
    'DISPID_SDKSetBinaryValue', 'SPWF_SRENGINE', 'SPEI_RESERVED2',
    'DISPID_SAFType', 'SAFT22kHz16BitMono', 'eLEXTYPE_USER_SHORTCUT',
    'SP_VISEME_16', 'SPRS_INACTIVE', 'DISPID_SpeechLexicon',
    'DISPID_SVWaitUntilDone', 'SRTStandard', 'SREInterference',
    'ISpStreamFormatConverter', 'ISpeechGrammarRule',
    'DISPID_SPRText', 'DISPID_SRCRecognizer', 'SVSFNLPMask',
    'DISPID_SRRAudioFormat', 'DISPID_SGRSTPropertyId',
    'DISPIDSPTSI_SelectionLength', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhraseElement', 'SPAR_High', 'DISPID_SRState',
    'SpeechGrammarTagWildcard', 'SpPhoneticAlphabetConverter',
    'SpeechBookmarkOptions', 'SVSFlagsAsync', 'ISpDataKey',
    'DISPID_SPRuleChildren', 'DISPID_SRGId',
    'DISPID_SRGIsPronounceable', 'DISPID_SPEPronunciation',
    'SAFTDefault', 'SpeechCategoryAppLexicons',
    ...
    'DISPID_SVSLastBookmarkId', 'DISPID_SDKOpenKey', 'SPPS_Noun',
    'DISPID_SAVolume', 'SpeechRunState', 'SPSNotOverriden',
    'DISPID_SPPValue', 'SPCATEGORYTYPE', 'DISPID_SRCERecognition',
    'DISPID_SLWsItem', 'DISPID_SPERetainedSizeBytes', 'SPFILEMODE',
    'SAFT16kHz16BitMono', 'SRAExport', 'SpMMAudioOut',
    'SAFT24kHz16BitMono', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechPhraseRules', 'SPEI_SR_RETAINEDAUDIO',
    'ISpeechPhraseAlternates', 'DISPID_SFSOpen',
    'SpeechCategoryRecognizers', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SWFEFormatTag', 'SAFT11kHz16BitStereo', 'SPGS_DISABLED',
    'DISPID_SPPNumberOfElements', 'DISPID_SASetState',
    'DISPID_SpeechXMLRecoResult', 'SpeechCategoryPhoneConverters',
    'ISpeechRecognizerStatus', 'ISpRecoCategory',
    'STSF_CommonAppData', 'SPPS_Verb', 'Speech_Default_Weight',
    'SpeechEngineProperties', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechLexiconWord', 'DISPID_SGRSTNextState',
    'SPBO_TIME_UNITS', 'ISpeechAudioStatus', 'DISPID_SLWLangId',
    'DISPID_SRCEAdaptation', 'SRADynamic', 'SPLOADOPTIONS', 'SVP_14',
    'eLEXTYPE_PRIVATE3', 'SPSHORTCUTPAIRLIST', 'SSTTDictation',
    'DISPID_SpeechLexiconWords', 'SGDSActiveUserDelimited',
    'SAFT44kHz8BitStereo', 'SPFM_CREATE', 'DISPID_SpeechVoiceEvent',
    'IEnumString', 'DISPID_SRGRules', 'DISPID_SFSClose',
    'SPINTERFERENCE_NOISE', 'SVP_4', 'ISpeechObjectTokenCategory',
    'SpeechEmulationCompareFlags', 'SAFTCCITT_ALaw_11kHzStereo',
    'SP_VISEME_7', 'SPAS_RUN', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPRuleName',
    'ISpeechGrammarRuleState', 'DISPID_SDKSetLongValue',
    'DISPID_SWFEChannels', 'SREStateChange', 'SPCS_DISABLED',
    'SAFT8kHz8BitStereo', 'DISPID_SRGCmdLoadFromObject', 'SASPause',
    'DISPID_SCSBaseStream', 'DISPID_SGRSTsCount',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRGCommit',
    'SPGRAMMARSTATE', 'DISPID_SPAsItem',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SLWsCount',
    'DISPID_SGRId', 'SVSFParseSapi', 'DISPID_SPRulesCount', 'SASRun',
    'SAFTNonStandardFormat', 'DISPID_SGRSRule', 'SAFTADPCM_22kHzMono',
    'SAFTGSM610_22kHzMono', 'tagSPTEXTSELECTIONINFO', 'SLTApp',
    'SPEI_SR_BOOKMARK', 'ISpeechAudio', 'SVP_5',
    'DISPID_SpeechObjectToken', 'DISPID_SVAlertBoundary',
    'SPSHORTCUTPAIR', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SGRSAddRuleTransition', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRsCount', 'SPPS_Function', 'SPAR_Unknown',
    'DISPID_SBSRead', 'SPCS_ENABLED', 'DISPID_SRGCmdLoadFromFile',
    'SPSUnknown', 'DISPID_SpeechPhraseProperties',
    'ISpGrammarBuilder', 'SPEVENTSOURCEINFO', 'SPEI_VISEME',
    'SGSExclusive', 'DISPID_SVSInputSentenceLength',
    'DISPID_SVEStreamStart', 'DISPID_SABufferNotifySize',
    'ISpeechBaseStream', 'SRERecognition',
    'DISPID_SpeechAudioBufferInfo', 'SP_VISEME_14',
    'IEnumSpObjectTokens', 'DISPID_SPIEngineId',
    'SPRECOCONTEXTSTATUS', 'SpCustomStream', 'ISpeechVoiceStatus',
    'SAFTADPCM_11kHzMono', 'DISPID_SVAudioOutputStream', 'SGDisplay',
    'DISPID_SpeechRecoResult2', 'DISPID_SRStatus', 'SPBO_PAUSE',
    'SVSFParseMask', 'SPEI_RECOGNITION', 'DISPID_SRRAlternates',
    'SVSFIsNotXML', 'SVP_16', 'DISPID_SPRulesItem',
    'SAFT11kHz16BitMono', 'SPBOOKMARKOPTIONS', 'DISPID_SPPsItem',
    'SpeechAudioFormatGUIDText', 'SP_VISEME_0', 'SpShortcut',
    'DISPID_SpeechGrammarRules', 'SPPHRASEREPLACEMENT',
    'SpPhraseInfoBuilder', 'SPINTERFERENCE_TOOSLOW', 'ISpeechDataKey',
    'SpeechAllElements', 'SECLowConfidence',
    'DISPID_SpeechAudioFormat', 'DISPID_SPACommit',
    'DISPID_SWFEBlockAlign', 'ISpVoice',
    'DISPID_SRGCmdLoadFromResource', 'SPCT_COMMAND',
    'SPEI_WORD_BOUNDARY', 'SPPS_Interjection',
    'DISPID_SRCERecognizerStateChange', 'SPRS_ACTIVE',
    'DISPID_SOTCreateInstance', 'SAFT11kHz8BitMono',
    'SECFEmulateResult', 'DISPID_SPIElements',
    'DISPID_SPERequiredConfidence', 'DISPID_SRSetPropertyNumber',
    'SWPUnknownWordPronounceable', 'SPRST_INACTIVE',
    'SpeechCategoryAudioOut', 'SVEPhoneme',
    'DISPID_SRCRequestedUIType', 'SPRST_ACTIVE_ALWAYS',
    'SPCT_SUB_DICTATION', 'DISPID_SVVolume', 'SPGS_ENABLED',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SMSAMMHandle',
    'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE17',
    ...
    'SPRST_INACTIVE_WITH_PURGE', 'SPDATAKEYLOCATION',
    'SAFTCCITT_uLaw_22kHzMono', 'SP_VISEME_13', 'SAFTGSM610_8kHzMono',
    'DISPID_SDKDeleteKey', 'DISPID_SLRemovePronunciation',
    'DISPID_SVEPhoneme', 'SITooQuiet',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechPhraseAlternate',
    'DISPIDSPRG', 'SDA_No_Trailing_Space', 'SpeechAudioVolume',
    'DISPID_SpeechVoice', 'SpUnCompressedLexicon',
    'SDKLCurrentConfig', 'SREPhraseStart',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpStreamFormat',
    'eLEXTYPE_RESERVED8', 'SPEI_ADAPTATION',
    'DISPID_SPRuleFirstElement', 'SECNormalConfidence',
    'STCLocalServer', 'SPPS_RESERVED2', 'SVSFParseSsml',
    'SECFIgnoreWidth', 'SPEVENTENUM', 'ISpEventSource',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCVoicePurgeEvent',
    'SPRULE', 'SVPOver', 'DISPID_SVSLastResult', 'SpMemoryStream',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRRTTickCount',
    'DISPID_SMSALineId', 'ISpeechLexiconPronunciation',
    'SpPhoneConverter', 'DISPID_SRCEventInterests',
    'DISPID_SDKSetStringValue', 'SPWORDLIST', 'ISpResourceManager',
    'SPWORDPRONOUNCEABLE', 'SREAudioLevel', 'DISPID_SPRuleId',
    'SPAR_Medium', 'SGSEnabled', 'ISpeechRecoResultTimes',
    'eWORDTYPE_ADDED', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRGCmdSetRuleState',
    'ISpRecognizer', 'ISpeechPhraseRules',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpObjectToken',
    'DISPID_SRGReset', 'SRSEIsSpeaking', 'DISPID_SPRuleConfidence',
    'DISPIDSPTSI_SelectionOffset',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SGRSTPropertyValue', 'SAFTADPCM_22kHzStereo',
    'ISpeechMMSysAudio', 'SVP_20',
    'DISPID_SPANumberOfElementsInResult', 'SRTReSent',
    'DISPID_SVSRunningState', 'ISpeechPhraseElement', 'SpStream',
    'DISPID_SGRsItem', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRCreateRecoContext', 'IInternetSecurityManager',
    'SpeechRuleState', 'DISPID_SOTsCount', 'DISPID_SOTsItem',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPEAudioStreamOffset',
    'WAVEFORMATEX', 'DISPID_SOTIsUISupported', 'SpeechVisemeType',
    'SSSPTRelativeToStart', 'DISPID_SVPriority',
    'DISPID_SRAudioInput', 'DISPID_SRRAudio', 'SPEI_END_SR_STREAM',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVESentenceBoundary',
    'DISPID_SpeechAudio', 'DISPID_SRRTStreamTime', 'DISPID_SOTCId',
    'ISpeechRecognizer', 'SASStop', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SLPLangId', 'SAFT32kHz16BitMono', 'DISPID_SLPsCount',
    'DISPID_SPIGrammarId', 'ISpeechPhraseReplacement', 'SECFDefault',
    'DISPID_SBSWrite', 'DISPID_SGRAddResource', 'SRERecoOtherContext',
    'SVP_13', 'SVEStartInputStream', 'SpSharedRecoContext',
    'SGSDisabled', 'ISpProperties', 'SPWF_INPUT',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRTExtendableParse',
    'ISpeechRecoResultDispatch', 'SpeechVoiceEvents',
    'DISPID_SVSyncronousSpeakTimeout', 'eLEXTYPE_RESERVED4',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SLGetPronunciations', 'SRSEDone', 'SVSFUnusedFlags',
    'DISPID_SOTs_NewEnum', 'DISPID_SRCEEnginePrivate', 'SVP_9',
    'SpStreamFormatConverter', 'ISpRecoGrammar', 'SSFMOpenReadWrite',
    'ISpeechVoice', 'Speech_Max_Pron_Length',
    ...
    'SpWaveFormatEx', 'SpeechDataKeyLocation', 'DISPID_SPILanguageId',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechRecognizerStatus',
    'SP_VISEME_3', 'DISPID_SOTDisplayUI', 'DISPID_SVGetProfiles',
    'SpInprocRecognizer', 'SPWT_PRONUNCIATION', 'SVEEndInputStream',
    'SpeechRegistryUserRoot', 'SpeechAudioFormatGUIDWave',
    'ISpeechXMLRecoResult', 'DISPID_SRCEInterference',
    'DISPID_SPIGetDisplayAttributes', 'SRTAutopause',
    'DISPID_SOTCEnumerateTokens', 'ISpPhrase', 'SpeechUserTraining',
    'eLEXTYPE_LETTERTOSOUND', 'SPFM_NUM_MODES',
    'ISpeechPhraseAlternate', 'SPAR_Low', 'SpeechRecoEvents',
    'SPWORDPRONUNCIATION', 'SRARoot', 'DISPID_SGRs_NewEnum',
    'SVF_None', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPIReplacements', 'ISpRecoGrammar2',
    'DISPID_SPRules_NewEnum', 'SpeechGrammarState',
    'DISPID_SLAddPronunciation', 'SLOStatic',
    'DISPID_SASCurrentSeekPosition', 'SPFM_OPEN_READWRITE',
    'DISPID_SRIsUISupported', 'DISPID_SVEAudioLevel', 'SBOPause',
    'SP_VISEME_5', 'SDA_Two_Trailing_Spaces', 'SpObjectToken',
    'SVP_8', 'SP_VISEME_18', 'SPPS_Noncontent', 'SpResourceManager',
    'SPAS_STOP', 'SPEVENT', 'SPEI_START_INPUT_STREAM',
    'SDTPronunciation', 'SPSHORTCUTTYPE', 'SP_VISEME_15',
    'DISPID_SRCEStartStream', 'DISPID_SPEEngineConfidence',
    'DISPID_SpeechRecoContextEvents', 'SVP_7',
    'DISPID_SRCRetainedAudio', 'SPWT_LEXICAL', 'SPEI_RESERVED5',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVResume',
    'SPPS_Modifier', 'IStream', 'DISPID_SABufferInfo',
    'DISPID_SpeechRecognizer', 'SP_VISEME_19',
    'DISPID_SGRSTransitions', 'DISPID_SGRSTsItem',
    'ISpObjectWithToken', 'SREBookmark', 'DISPID_SDKEnumValues',
    'SINoSignal', 'DISPID_SVStatus', 'SAFT16kHz8BitMono',
    'SpeechGrammarTagDictation', 'DISPID_SRProfile',
    'SPEI_RECO_STATE_CHANGE', 'SGDSInactive', 'STCAll',
    'ISpRecognizer2', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFT48kHz8BitMono', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SpeechFileStream', 'DISPID_SPIRetainedSizeBytes',
    'SPAS_PAUSE', 'SPXRO_Alternates_SML', 'SpeechDiscardType',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTADPCM_44kHzMono',
